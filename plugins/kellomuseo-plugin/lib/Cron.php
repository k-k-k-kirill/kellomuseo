...
use \Pixels\Kellomuseo\Cron\ExampleCron;

/**
 * Kellomuseo Cron class
 *
 * @since 1.0
 * @author Pixels
 */
...
class Cron {
	...
	public function __construct() {
		...
		add_action( self::EXAMPLE_CRON, 'Pixels\Kellomuseo\Cron\ExampleCron::example' );
	}
	...
	public function register_custom_schedules( $schedules ) {
		...
		if ( ! isset( $schedules['15min'] ) ) {
			$schedules['15min'] = array(
				'interval' => 60 * 15,
				'display'  => __( 'Every 15 minutes', 'kellomuseo-plugin' ),
			);
		}
